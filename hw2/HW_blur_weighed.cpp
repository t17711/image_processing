...
void
getBlur_1D_w(IP::ChannelPtr<uchar> p1, int width, int steps, int size, IP::ChannelPtr<uchar> p2) {
...
void
HW_blur_w(ImagePtr I1, int xsz, int ysz, ImagePtr I2)
{
